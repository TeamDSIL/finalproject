<template>
  ...
  <div style="font-size: 11px; color: grey;">(주)드실은 예약 및 구매관련 통신판매업자가 제공하는 상품, 거래정보 및 거래 등에 대하여 책임을 지지 않습니다.</div>
</div>
...
<v-dialog v-model="privacyModal" max-width="600">
    <v-card>
      ...
      <v-card-text>
        <!-- 여기에 동의서 내용을 넣으세요 -->
        <p>주식회사 드실(이하 "회사"라 한다)은 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법 등 관련 법령에 따라 이용자의 개인정보를 보호하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립합니다.<br>
개인정보처리방침은 이용자가 언제나 쉽게 열람할 수 있도록 서비스 초기화면을 통해 공개하고 있으며 관련법령, 지침, 고시 또는 캐치테이블 서비스 정책의 변경에 따라 달라질 수 있습니다.</p> <br>
<p style="color: black; font-size: 16px;"><b>1. 개인정보의 수집·이용</b></p>
<p>회사는 다음과 같이 이용자의 개인정보를 수집합니다. 처리하고 있는 개인정보는 다음의 수집·이용 목적 이외의 용도로는 활용되지 않으며, 수집·이용 목적이 변경되는 경우에는 개인정보보호법에 따라 별도의 동의를 받는 등 필요한 조치를 이행합니다.</p><br>
...
<table style="border-collapse: collapse;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="border: 1px solid black;">목적달성(회원 탈퇴 등) 후 지체없이 파기 (단, 관련법령 및 회사정책에 따라 별도 보관되는 정보는 예외)</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid black;">타사 계정 이용</td>
                        <td style="border: 1px solid black;">회원 식별, 회원제 서비스 제공, 상담 관리, 휴대전화번호 인증</td>
                        <td style="border: 1px solid black;">휴대전화번호, 닉네임, 이름, 생년월일, (선택)프로필이미지 <br> *수집하는 개인정보 : 휴대전화번호, 닉네임, 이름, 생년월일, (선택)프로필이미지 <br> *회사가 제3자로부터 제공받은 개인정보: 카카오 ID, 이름, (선택)성별, 연령대, 생일, 출생연도; 네이버 ID, 이름, 별명, 휴대전화번호, (선택)성별, 연령대, 생일, 출생연도, 이메일주소; Apple ID, 이메일주소, Apple ID 코드; 페이스북, 사용자 ID</td>
                        <td style="border: 1px solid black;">목적달성(회원 탈퇴 등) 후 지체없이 파기 (단, 관련법령 및 회사정책에 따라 별도 보관되는 정보는 예외)</td>
                    </tr>
                    <tr>
                        ...
                        <td style="border: 1px solid black;">카드정보 : 카드번호, 카드 비밀번호 앞2자리, 유효기간(월/년도) <br> 본인인증 정보 : CI, 휴대전화번호, 생년월일, 성별, 이름, 내/외국인여부</td>
...
<p>5) 회사는 회원관리, 불법 및 부정이용 방지, 서비스 이용기록 통계 및 분석, 서비스 개선, 신규서비스 개발 목적으로 수집한 모든 개인정보와 자동 수집 정보를 사용할 수 있습니다.</p><br>

<p style="color: black; font-size: 16px;"><b>2. 개인정보 제3자 제공</b></p><br>
<P>회사는 이용자의 개인정보를 개인정보 수집·이용 목적에서 명시한 범위 내에서 사용하며, 이용자의 사전 동의 없이 개인정보 수집·이용 목적 범위를 초과하여 이용하거나 원칙적으로 이용자의 개인정보를 제공하지 않습니다. 다만, 아래와 같이 양질의 서비스 제공을 위해 이용자의 개인정보를 협력업체와 공유할 필요가 있는 경우에는 제공 받는 자, 제공목적, 제공정보 항목, 이용 및 보유기간 등을 회원에게 고지하여 동의를 구하거나 관련법령에 따른 경우는 예외로 합니다.</P><br>
<p>① 이용자가 사전에 공개 또는 제3자 제공에 동의한 경우</p><table style="border-collapse: collapse;">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="border: 1px solid black;">레스토랑 예약 및 대기 서비스 제공(서비스 계약 이행, 예약 및 대기자 확인, 예약 및 대기 관리, 재방문고객 식별, 고객 상담, 고객 관리, 문의 및 상담) 및 제공거절</td>
                        <td style="border: 1px solid black;">휴대전화번호, 예약 및 대기자명, 결제정보, 기타 예약 및 대기를 위해 필요한 정보</td>
                        <td style="border: 1px solid black;">예약 및 대기를 통한 레스토랑 방문일로부터 6개월이 경과한 때까지 보관. 단, (i) 매장이 방문일로부터 2년 이내의 기간을 정해 제공거절목록에 등록한 경우 매장이 제공거절목록 등록을 해제하는 때와 방문일로부터 6개월이 경과한 때 중 나중에 도래하는 때까지 보관하고, (ii) 관계법령에 정해진 규정이 있는 경우 이에 따라 법정기간 동안 보관함</td>
                    </tr>
                    <tr>
                        ...
                        <td style="border: 1px solid black;">고객을 식별할 수 있는 정보로서 멀티플랫폼 서비스 제공자가 와드에 제공한 정보, 예약 및 대기 신청 정보, 방문일시, 방문인원</td>
                        <td style="border: 1px solid black;">목적달성(멀티플랫폼 서비스 회원 탈퇴 등)후 지체없이 파기(단, 관련법령에 따라 별도 보관되는 정보는 예외)</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid black;">카드사(삼성 / 현대 / 롯데 / 하나 / 신한 / 비씨 / KB국민 / NH농협 / VISA / MASTERS / JCB / AMEX / UNIONPAY)</td>
            ...
            <p>② 회사는 멀티플랫폼 서비스를 제공하는 사업자(이하 “멀티플랫폼 협력사”라 한다)의 채널을 통해 서비스에 진입하여 예약 및 대기를 이용한 경우 다음의 기준에 따라 정보주체의 동의 없이 (i) 그 예약 및 대기 이용기록 및 (ii) 정보주체를 식별할 수 있는 정보로서 멀티플랫폼 협력사로부터 제공받은 정보를, 정보주체가 서비스에 진입하기 위해 이용한 멀티플랫폼 협력사에 제공할 수 있습니다.
</p><br>
...
<p>(3) 회사는 파트너 서비스 채널이 이미 정보주체의 개인정보를 보유한 점, 예약 및 대기 이용 시 그 이용기록 열람은 반드시 필요한 점, 멀티플랫폼 협력사의 채널에서 이용기록 삭제 기능이 제공되는 점, 이용기록 연동을 원치 않는 자는 즉시 제공 중단조치를 취하는 점 등을 포함하여 정보주체의 이익이 부당하게 침해되지 아니하도록 고려하였습니다.</p><br>
...
<p>① 회사는 원활하고 향상된 서비스를 제공하기 위해서 개인정보 처리 업무를 다른 회사에 위탁할 수 있습니다. 회사는 개인정보 처리 업무 위탁 시 이용자의 개인정보가 안전하게 처리될 수 있도록 관리·감독하며 다른 목적으로 이용자의 개인정보를 처리하지 않도록 제한합니다.</p><br>
...
<table style="border-collapse: collapse;">
            ...
            <p>① 회사는 이용자의 개인정보를 원칙적으로 보유·이용기간의 경과, 처리목적 달성, 서비스 이용약관에 따른 계약해지 등 개인 정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</p><br>
            <p>② 이용자로부터 동의 받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는 해당 개인정보를 별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다. - 다른 법령에 따라 개인정보를 보관하는 경우는 다음과 같습니다.</p><br>
            <table style="border-collapse: collapse;">
                <thead>
                    <tr>
...
- 이 경우 회사는 개인정보가 파기되거나 분리되어 저장·관리된다는 사실, 서비스 미이용 기간 만료일, 해당 개인정보의 항목을 공지사항, 전자우편 등의 방법으로 미이용 기간 30일 전에 이용자에게 알릴 수 있습니다. 이를 위해 이용자는 회사에게 정확한 연락처 정보를 알리거나 수정하여야 합니다.</p><br>
<p>④ 개인정보 파기의 절차 및 방법은 다음과 같습니다.
- 파기 절차 : 회사는 파기 사유가 발생한 개인정보를 개인정보 보호 책임자의 승인 절차를 거쳐 파기합니다.
- 파기 방법 : 회사는 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 기술적인 방법 또는 물리적인 방법을 이용하여 파기하며, 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각등을 통하여 파기합니다.</p><br>
...
<p>① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 고객님의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자 및 개인정보보호 담당자를 지정하고 있습니다.
② 이용자께서는 회사의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보와 관련된 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당자에게 문의하실 수 있습니다. 회사는 이용자의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</p><br>
...
<p>이용자는 아래 이 기관에 대해 개인정보 침해에 대한 피해구제 상담 등을 문의하실 수 있습니다. 아래의 기관은 정보기관 소속으로서, 회사의 자체적인 개인정보 불만처리 또는 개인정보 피해구제 결과에 만족하지 못하실 경우, 자세한 도움이 필요하실 경우에는 문의하여 주시기 바랍니다.</p><br>
<table style="border-collapse: collapse;">
    <thead>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td style="border: 1px solid black;"><a href="https://privacy.kisa.or.kr" target="_blank">privacy.kisa.or.kr</a></td>
        </tr>
        <tr>
            <td style="border: 1px solid black;">대검찰청 사이버범죄수사단</td>
            <td style="border: 1px solid black;">1301</td>
            <td style="border: 1px solid black;"><a href="https://www.spo.go.kr" target="_blank">www.spo.go.kr</a></td>
        </tr>
        <tr>
            <td style="border: 1px solid black;">경찰청 사이버안전국</td>
            <td style="border: 1px solid black;">182</td>
            <td style="border: 1px solid black;"><a href="https://www.cyber.go.kr" target="_blank">www.cyber.go.kr</a></td>
        </tr>
        <tr>
            <td style="border: 1px solid black;">전자거래분쟁조정위원회</td>
            <td style="border: 1px solid black;">1661-5714</td>
            <td style="border: 1px solid black;"><a href="https://www.ecmc.or.kr" target="_blank">www.ecmc.or.kr</a></td>
        </tr>
    </tbody>
</table><br>
...
.btn-large {
        font-size: 16px !important; /* 버튼 텍스트 크기 */
        padding: 10px 24px !important; /* 버튼 내용물 패딩 */
    }
