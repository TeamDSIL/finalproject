  ...
  <div>
    <v-container style="margin-bottom: 30px">
      <v-col cols="12" class="restaurant-title-img">
        ...
        <div class="ps-0 text-primary" style="font-size: larger; font-weight: bold">
          마이다이닝
        </div>
      </v-col>
      <div>
        ...
        <v-tabs-items v-model="tab">
          <v-tab-item value="tab-1">
                ...
                <div slot="boxContent">
                  <div class="px-8">
                    <v-row>
                      ...
                      <v-col cols="12" v-for="reservation in paginatedData" :key="reservation.reservationId">
                        <div class="d-flex justify-space-between align-center flex-wrap">
                          <div class="d-flex flex-wrap">
                            ...
                            <div>
                              <div style="display: flex">
                                <h5 class="f-600 mb-3" style="margin-right: 10px">
                                  {{ reservation.name }}
                                </h5>

                                <span style="display: flex">
                                  <span v-for="index in Math.floor(
                                    reservation.averageReviewScore
                                  )" :key="'full-' + index">
                                    <v-img :src="require('~/assets/images/babscore.png')
                                      " width="20px" class="fixed-size" alt="Full Star"></v-img>
                                  </span>
                                  <!-- 소수점이 있으면 반 별 추가 -->
                                  <span v-if="
                                    hasHalfStar(
                                  ...
                                  ">
                                    <v-img :src="require('~/assets/images/half-babscore.png')
                                      " width="10px" class="fixed-size" alt="Half Star"></v-img>
                                  </span>
                                  ...
                                  <h6 class="ms-3 grey--text text--darken-1 font-weight-light">
                                    ({{ reservation.reviewCount }})
                                  </h6>
                                </span>
                              </div>
                              <v-chip class="text-uppercase mb-2" :class="{
                                'green lighten-2':
                              ...
                              <div>
                                <span class="text-14 grey--text text--darken-4 me-2 mb-0">시간:
                                  {{
                                    formatTime(reservation.reservationTime)
                                  }}</span>

                                <span class="text-14 grey--text text--darken-4 me-2 mb-0">인원수: {{
                                  reservation.peopleCount }}명</span>
                          ...
                          <div>
                            <v-btn outlined color="primary" small class="delete-button" @click="
                              requestDeny(
                                reservation.reservationId,
                                reservation.reservationState
                              )
            ...
            <v-pagination class="food-truck-pagination" v-model="currentPage" :length="pageCount" circle
              @input="scrollToTop"></v-pagination>
          </v-tab-item>
          <v-tab-item value="tab-2">
                ...
                <div slot="boxContent">
                  <div class="px-8">
                    <v-row>
                      ...
                      <v-col cols="12" v-for="like in paginatedData1" :key="like.bookmarkId">
                        <div class="d-flex justify-space-between align-center flex-wrap">
                          <div class="d-flex flex-wrap">
                            <v-avatar class="me-3" size="150" tile>
                            ...
                            <div>
                              ...
                              <div class="d-flex mb-3">
                                <span style="display: flex">
                                  ...
                                  <!-- 소수점이 있으면 반 별 추가 -->
                                  <span v-if="hasHalfStar(like.averageReviewScore)">
                                    <v-img :src="require('~/assets/images/half-babscore.png')
                                      " width="10px" class="fixed-size" alt="Half Star"></v-img>
                                  </span>
                                  <span class="font-weight-bold text-14 ms-2">
                              ...
                              <div>
                                <p class="text-14 grey--text text--darken-4 me-2 mb-0">
                                  주소: {{ like.address }}
                                </p>
                                <p class="text-14 grey--text text--darken-4 me-2 mb-0">
                                  전화번호: {{ like.tel }}
                                ...
                                <nuxt-link :to="`/restaurant/detail/${like.restaurantId}`">
                                  <v-btn color="primary" small class="detail-read-view">
                                    자세히 보기
                                  </v-btn>
                                </nuxt-link>
                          ...
                          <div>
                            <v-btn outlined color="primary" small class="like-delete-button"
            ...
            <v-pagination class="food-truck-pagination" v-model="currentPage1" :length="pageCount1" circle
              @input="scrollToTop"></v-pagination>
          </v-tab-item>
          <v-tab-item value="tab-3">
            <v-row>
              ...
              <v-col cols="12" lg="6" v-for="review in paginatedData2" :key="review.reviewId">
                <!-- user-post  -->
                <div class="mb-6">
                  <div class="d-flex align-center flex-wrap mb-4">
                    ...
                    <v-btn outlined color="primary" small class="delete-button" style="margin-left: 30px"
                  ...
                  <div class="d-flex align-center mb-2">
                    ...
                    <span class="font-weight-bold text-14 ms-2">{{ review.score }}.0</span>
            ...
            <div class="mb-4">
              <v-pagination class="food-truck-pagination" v-model="currentPage2" :length="pageCount2" circle
                @input="scrollToTop"></v-pagination>
            </div>
          </v-tab-item>
        </v-tabs-items>
  ...
  methods: {
    ...
    async fetchReviews() {
      try {
        ...
        const response = await axios.get(`${process.env.API_URL}/myDining/reviews/${id}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          },
          withCredentials: true
    ...
    async fetchReservations() {
      try {
        ...
        // URL의 id 파라미터를 가져옵니다
        const id = this.user.id;
        const response = await axios.get(`${process.env.API_URL}/myDining/reservations/${id}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          },
          withCredentials: true
    ...
    async fetchBookmarks() {
      try {
        ...
        // URL의 id 파라미터를 가져옵니다
        const id = this.user.id;
        const response = await axios.get(`${process.env.API_URL}/myDining/bookmarks/${id}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          },
          withCredentials: true
