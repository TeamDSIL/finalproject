          ...
          <v-tabs-items v-model="tab">
            <v-tab-item value="tab-1">
              <div class="carousel-container">
                <v-carousel hide-delimiters height="500px" cycle interval="2000">
                  <v-carousel-item v-for="(item, i) in items" :key="i">
                    <div class="image-wrapper">
                      <div class="image-background" :style="{ backgroundImage: 'url(' + item.src + ')' }"></div>
                      <v-img :src="item.src" contain @click.native="navigateTo(item.name)" height="500px"
                        class="image-foreground"></v-img>
                    </div>
                  </v-carousel-item>
                </v-carousel>
              </div>
